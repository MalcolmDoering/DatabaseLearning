...
#expLogDir = tools.logDir+"/2019-05-17_11-30-24_actionPrediction12_dbl - save" # 2 training databases, presented in 20190524 meeting
#expLogDir = tools.logDir+"/2019-05-21_14-54-06_actionPrediction13_dbl - save" # 10 training databases, presented in 20190524 meeting

#expLogDir = tools.logDir+"/2019-05-24_19-00-07_actionPrediction13_dbl - GT DB entries" # 10 databases, GT database entries given
#expLogDir = tools.logDir+"/2019-05-31_11-34-31_actionPrediction13_dbl" # 10 databases, GT database entries given, and the new metrics, only shopkeeper responses to question about price included in data

#expLogDir = tools.logDir+"/2019-06-03_18-17-08_actionPrediction13_dbl" # 10 databases, GT database entries given, DB entries padded with 0 vecs
#expLogDir = tools.logDir+"/2019-06-05_13-47-27_actionPrediction13_dbl" # 10 databases, GT database entries given, DB entries padded with 0 vecs

#expLogDir = tools.logDir+"/2019-06-06_16-33-38_actionPrediction13_dbl" # 10 databases, GT database entries given, DB entries padded with 0 vecs, reduced batch size and unrandomized training instance order
#expLogDir = tools.logDir+"/2019-06-06_16-55-22_actionPrediction13_dbl" # 10 databases, GT database entries given, DB entries padded with 0 vecs, reduced batch size and randomized training instance order

#expLogDir = tools.logDir+"/2019-06-07_15-05-37_actionPrediction13_dbl" # 10 databases all data, GT database entries given, DB entries padded with 0 vecs, reduced batch size and unrandomized training instance order



#expLogDir = tools.logDir+"/2019-06-10_14-30-33_actionPrediction13_dbl" # 10 databases, relu and softmax addressing, DB entries padded with 0 vecs, reduced batch size and unrandomized training instance order, softmaxed over weighted DB entry sums




#expLogDir = tools.logDir+"/2019-05-31_15-35-15_actionPrediction13_dbl" # 2 databases, GT database entries given, and the new metrics, only shopkeeper responses to question about price included in data



#expLogDir = tools.logDir+"/2019-05-31_17-54-56_actionPrediction13_dbl" # 2 databases, temp grid search, and the new metrics, only shopkeeper responses to question about price included in data
#expLogDir = tools.logDir+"/2019-06-03_13-03-18_actionPrediction13_dbl" # 10 databases, temp grid search, and the new metrics, only shopkeeper responses to question about price included in data

#expLogDir = tools.logDir+"/2019-06-07_11-47-14_actionPrediction13_dbl" # 10 databases, temp grid search, and the new metrics, only shopkeeper responses to question about price included in data, 50 batch unrandomized


#expLogDir = tools.logDir+"/2019-05-27_12-29-06_actionPrediction13_dbl" # 10 databases, sharpening used for addressing
#expLogDir = tools.logDir+"/2019-05-28_14-34-02_actionPrediction13_dbl" # 10 databases, sharpening used for addressing, and the new metrics
...
#expLogDir = tools.logDir+"/2019-06-06_17-30-06_actionPrediction13_dbl" 
...
#expLogDir = tools.logDir+"/2019-06-12_18-48-35_actionPrediction13_dbl" 
...
# combined loc and utt input to addressing layer, loc layer, and decoder initialization
# result:
#expLogDir = tools.logDir+"/2019-06-13_12-00-52_actionPrediction13_dbl" 
...
# result: it works!
#expLogDir = tools.logDir+"/2019-06-13_17-59-54_actionPrediction13_dbl" 
...
#expLogDir = tools.logDir+"/2019-06-14_11-14-59_actionPrediction13_dbl" 
...
#expLogDir = tools.logDir+"/2019-06-14_16-55-45_actionPrediction13_dbl" 
...
# 
# result: 
#expLogDir = tools.logDir+"/2019-06-17_17-10-31_actionPrediction13_dbl"
...
# result: 
#expLogDir = tools.logDir+"/2019-06-18_12-40-37_actionPrediction13_dbl"
...
# result: 
#expLogDir = tools.logDir+"/2019-06-19_17-08-11_actionPrediction13_dbl"
...
# result: 
#expLogDir = tools.logDir+"/2019-06-20_11-22-07_actionPrediction13_dbl"
...
# result: 
#expLogDir = tools.logDir+"/2019-06-21_11-59-10_actionPrediction13_dbl"
...
# result: 
expLogDir = tools.logDir+"/2019-06-24_11-46-31_actionPrediction13_dbl"
...
# result: not good
#expLogDir = tools.logDir+"/2019-06-21_18-34-39_actionPrediction13_dbl"
...
# result: 
expLogDir = tools.logDir+"/2019-06-24_18-05-48_actionPrediction14_dbl"



expLogDir = tools.logDir+"/2019-06-25_17-58-50_actionPrediction14_dbl"


expLogDir = tools.logDir+"/2019-06-26_11-34-59_actionPrediction14_dbl"
...
expLogDir = tools.logDir+"/2019-06-26_18-06-16_actionPrediction14_dbl"
...
# result: reaches 100% in the training but lots of up and down spikes. does not generalize at all to the testing set
expLogDir = tools.logDir+"/2019-06-27_14-22-39_actionPrediction14_dbl"
...
# something else...?
#expLogDir = tools.logDir+"/2019-06-27_16-16-40_actionPrediction13_dbl"
...
# copy net used
# result: 
#expLogDir = tools.logDir+"/2019-06-27_18-23-44_actionPrediction13_dbl"
...
#expLogDir = tools.logDir+"/2019-06-27_18-54-45_actionPrediction13_dbl"
...
# 
#expLogDir = tools.logDir+"/2019-06-28_10-55-05_actionPrediction13_dbl"
...
# result: it works. the training instance randomization was causing the problem
# 
#expLogDir = tools.logDir+"/2019-06-28_11-23-06_actionPrediction13_dbl"


# same as above but with TF set to .3 and no TF used on inference
#expLogDir = tools.logDir+"/2019-06-28_11-57-25_actionPrediction13_dbl"


# same as above but with tanh softmax used for addressing
expLogDir = tools.logDir+"/2019-06-28_13-58-36_actionPrediction13_dbl"



# same as above but with GS for addressing, grid search over temps
expLogDir = tools.logDir+"/2019-06-28_19-31-28_actionPrediction13_dbl"
...
# result: 
#
expLogDir = tools.logDir+"/2019-07-02_17-51-46_actionPrediction13_dbl"
...
# result: 
#
expLogDir = tools.logDir+"/2019-07-02_18-21-39_actionPrediction13_dbl"


expLogDir = tools.logDir+"/2019-07-03_12-06-43_actionPrediction13_dbl"

# price only, uniform initialization
expLogDir = tools.logDir+"/2019-07-03_16-42-14_actionPrediction13_dbl"


# price only, customer utterance variety, normal initialization
expLogDir = tools.logDir+"/2019-07-03_17-29-23_actionPrediction13_dbl"

# price only, customer utterance variety, uniform initialization
expLogDir = tools.logDir+"/2019-07-04_13-10-38_actionPrediction13_dbl"
...
# 
expLogDir = tools.logDir+"/2019-07-05_17-31-56_actionPrediction14_dbl"
...
expLogDir = tools.logDir+"/"

# copynet
# 10 train
# price only
# gumbelSoftmaxTemp = max((-1.0/2000) * e + 3, 0.05)
expLogDir = tools.logDir+"/2019-07-08_16-34-31_actionPrediction13_dbl"
...
#expLogDir = tools.logDir+"/2019-07-08_18-33-50_actionPrediction13_dbl"
...
# result: performance dropped at 3000 and addressing stopped working
#expLogDir = tools.logDir+"/2019-07-09_12-26-09_actionPrediction13_dbl"
...
# result: performance dropped at 3000 and addressing stopped working
#expLogDir = tools.logDir+"/2019-07-09_13-23-24_actionPrediction13_dbl"
...
#expLogDir = tools.logDir+"/2019-07-09_17-51-05_actionPrediction13_dbl"
...
#expLogDir = tools.logDir+"/2019-07-10_12-51-05_actionPrediction13_dbl"


#expLogDir = tools.logDir+"/2019-07-10_16-50-46_actionPrediction13_dbl"
...
expLogDir = tools.logDir+"/2019-07-11_12-29-27_actionPrediction13_dbl"
...
#expLogDir = tools.logDir+"/2019-07-11_17-49-44_actionPrediction13_dbl"
...
# two input encodings
expLogDir = tools.logDir+"/2019-07-17_13-46-14_actionPrediction14_dbl"

# non-copynet architecture with the copy buffer error fixed
# with softmax addresses, price only, LR 0.0001 Adam
# only one input encoding
expLogDir = tools.logDir+"/2019-07-17_15-16-11_actionPrediction14_dbl"
...
expLogDir = tools.logDir+"/2019-07-17_16-09-29_actionPrediction14_dbl"
...
expLogDir = tools.logDir+"/2019-07-17_17-56-59_actionPrediction14_dbl"
...
# variety of customer utterances
# embedding size 100
#expLogDir = tools.logDir+"/2019-07-18_12-22-11_actionPrediction14_dbl"
...
# embedding size 100
#expLogDir = tools.logDir+"/2019-07-18_13-34-09_actionPrediction14_dbl - GT addresses all data"
...
# 10 databases with only prices changing
# embedding size 100
expLogDir = tools.logDir+"/2019-07-21_14-44-40_actionPrediction14_dbl - SM addresses all data"
...
# 2 handmade databases with all attributes changing
# embedding size 100
#expLogDir = tools.logDir+"/2019-07-22_16-55-13_actionPrediction14_dbl"


expLogDir = tools.logDir+"/2019-07-23_17-38-43_actionPrediction14_dbl"

expLogDir = tools.logDir+"/2019-07-24_17-48-26_actionPrediction14_dbl"

# non-copynet with RNN interaction history encoder
expLogDir = tools.logDir+"/2019-07-26_19-59-46_actionPrediction15_dbl"
...
#expLogDir = tools.logDir+"/2019-07-29_18-53-49_actionPrediction15_dbl"

# non-copynet with RNN interaction history encoder unigram utt vec
expLogDir = tools.logDir+"/2019-07-31_16-34-21_actionPrediction15_dbl"


# non-copynet with RNN interaction history encoder unigram utt vec
# simulated interactions with feature/camera introduction probs from h-h data
expLogDir = tools.logDir+"/2019-08-02_19-27-47_actionPrediction15_dbl"


# non-copynet with RNN interaction history encoder unigram utt vec
# simulated interactions with vastly altered simulations that allow customer to take initiative
expLogDir = tools.logDir+"/2019-08-08_18-27-30_actionPrediction15_dbl"



expLogDir = tools.logDir+"/2019-09-13_12-49-12_actionPrediction15_dbl"


# uses the crowdsourced shopkeeper utterances
expLogDir = tools.logDir+"/2019-11-13_19-26-45_actionPrediction15_dbl"
