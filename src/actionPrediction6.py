    ...
    with train_graph.as_default():
        ...
        for e in range(numEpochs):
            ...
            if e % 100 == 0:
                ...
                # TRAIN
                trainUttPreds, trainCopyScores, trainGenScores = sess.run([pred_op, copy_scores, gen_scores], feed_dict=train_feed_dict)
                ...
                # TEST
                testUttPreds, testCopyScores, testGenScores = sess.run([pred_op, copy_scores, gen_scores], feed_dict=test_feed_dict)
