...
copied from analysis7
for visualizing output of actionPrediction18
'''
...
#expLogName = "2020-01-20_15-57-56_actionPrediction18_dbl/proposed"

expLogName = "2020-01-21_18-57-27_actionPrediction18_dbl/proposed" # no speech cluster loss weights, ignore junk, training error fixed

expLogDir = tools.logDir+"/"+expLogName



sessionDir = sessionDir = tools.create_session_dir("analysis9")
...
save_1_metric_graph(runIdToData, "Speech Cluster Correct")
